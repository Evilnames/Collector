...
BREED_SILHOUETTES = {
    ...
    "Saint Bernard":        (28, 14, 8, 14, 13, 5),
    # ── 25 added breeds ───────────────────────────────────────────────────────
    "Pomeranian":           (13,  6, 3,  7,  7, 3),
    "Maltese":              (13,  6, 3,  7,  7, 3),
    "Pekingese":            (14,  6, 2,  9,  7, 2),
    "Shih Tzu":             (15,  7, 3,  8,  8, 3),
    "Havanese":             (16,  7, 4,  8,  8, 3),
    "Cavalier King Charles":(16,  8, 4,  9,  8, 4),
    "Bichon Frise":         (16,  8, 4,  8,  8, 3),
    "Cairn Terrier":        (17,  8, 4,  8,  8, 4),
    "Lhasa Apso":           (17,  8, 4,  8,  8, 3),
    "Tibetan Terrier":      (19,  9, 5,  9,  9, 4),
    "American Eskimo":      (19,  9, 5,  9,  9, 4),
    "Cocker Spaniel":       (20,  9, 5,  9,  9, 4),
    "Keeshond":             (21, 11, 6, 10, 10, 4),
    "Schnauzer":            (21, 10, 6,  9,  9, 5),
    "Puli":                 (21, 10, 6,  9,  9, 4),
    "Brittany":             (22, 10, 7,  9,  9, 5),
    "Finnish Lapphund":     (22, 11, 6, 10, 10, 4),
    "Norwegian Elkhound":   (22, 11, 6, 10, 10, 4),
    "Boxer":                (23, 11, 7, 12, 10, 3),
    "Spinone Italiano":     (24, 11, 7, 11, 10, 5),
    "Old English Sheepdog": (25, 13, 7, 12, 12, 4),
    "Briard":               (25, 12, 8, 11, 11, 5),
    "Komondor":             (27, 13, 7, 13, 12, 4),
    "Newfoundland":         (28, 14, 7, 14, 13, 4),
    "Tibetan Mastiff":      (28, 14, 7, 14, 13, 4),
}
...
SIZE_CLASS_SILHOUETTES = {
    ...
    "large":    (24, 11, 7, 11, 10, 4),
    "giant":    (26, 13, 7, 12, 12, 4),
    "colossal": (28, 14, 7, 14, 13, 4),
}
