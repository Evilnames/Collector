...
def draw_entities(renderer, entities):
    ...
    for e in entities:
        ...
        elif aid == "llama":          renderer._draw_llama(sx, sy, e)
        elif aid == "yak":            renderer._draw_yak(sx, sy, e)
        elif aid == "pig":            renderer._draw_pig(sx, sy, e)
        ...
        elif aid == "npc_knight":     renderer._draw_npc_knight(sx, sy, e)
        ...
        elif aid == "caribou":        renderer._draw_caribou(sx, sy, e)
        elif aid == "antelope":       renderer._draw_antelope(sx, sy, e)
        elif aid == "ibex":           renderer._draw_ibex(sx, sy, e)
        elif aid == "lynx":           renderer._draw_lynx(sx, sy, e)
        elif aid == "coyote":         renderer._draw_coyote(sx, sy, e)
        elif aid == "beaver":         renderer._draw_beaver(sx, sy, e)
