...
FISH_TYPE_ORDER = [
    ...
    # Temperate
    "perch", "yellow_perch", "bass", "smallmouth_bass", "white_bass",
    "bluegill", "sunfish", "pumpkinseed", "rock_bass",
    "crappie", "walleye", "carp", "tench", "roach", "rudd",
    "chub", "bream", "channel_catfish", "muskie", "golden_koi",
    # Cold
    "trout", "brown_trout", "brook_trout", "arctic_char", "dolly_varden",
    "grayling", "golden_trout",
    "cisco", "lake_whitefish", "round_whitefish", "burbot",
    ...
    "pickerel", "snakehead", "longnose_gar", "grass_carp", "gar", "alligator_gar",
]
...
FISH_BIOME_GROUPS = [
    ...
    ("Temperate",       ["perch", "yellow_perch", "bass", "smallmouth_bass", "white_bass",
                         "bluegill", "sunfish", "pumpkinseed", "rock_bass",
                         "crappie", "walleye", "carp", "tench", "roach", "rudd",
                         "chub", "bream", "channel_catfish", "muskie", "golden_koi"]),
    ("Cold / Boreal",   ["trout", "brown_trout", "brook_trout", "arctic_char", "dolly_varden",
                         "grayling", "golden_trout",
                         "cisco", "lake_whitefish", "round_whitefish", "burbot",
                         "salmon", "steelhead", "pike", "sturgeon"]),
    ...
    ("Wetland / Swamp", ["warmouth", "flier", "mudskipper", "bowfin", "walking_catfish",
                         "pickerel", "snakehead", "longnose_gar", "grass_carp",
                         "gar", "alligator_gar"]),
]
