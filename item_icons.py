...
_ICONS = {
    ...
    "artisan_bench_item":    _machine,
    "polished_granite":      _slab,
    "polished_marble":       _slab,
    "slate_tile":            _slab,
    "terracotta":            _slab,
    "mossy_brick":           _slab,
    "cream_brick":           _slab,
    "charcoal_plank":        _slab,
    "walnut_plank":          _slab,
    "oak_panel":             _slab,
    "bamboo_panel":          _slab,
    "obsidian_tile":         _slab,
    ...
    "lapis_brick":           _slab,
    "basalt_column":         _slab,
    "limestone_block":       _slab,
    "copper_tile":           _slab,
    "teak_plank":            _slab,
    "driftwood_plank":       _slab,
    "cedar_panel":           _slab,
    "jade_panel":            _slab,
    "rose_quartz_block":     _slab,
    "gilded_brick":          _slab,
    "amethyst_block":        _slab,
    "amber_tile":            _slab,
    "ivory_brick":           _slab,
    "ebony_plank":           _slab,
    "mahogany_plank":        _slab,
    "ash_plank":             _slab,
    "frosted_glass":         _slab,
    "crimson_brick":         _slab,
    "terracotta_shingle":    _slab,
    "thatch_roof":           _slab,
    "verdigris_copper":      _slab,
    "silver_panel":          _slab,
    "gold_leaf_trim":        _slab,
    "stained_glass_red":     _slab,
    "stained_glass_blue":    _slab,
    "stained_glass_green":   _slab,
    "quartz_pillar":         _slab,
    "onyx_inlay":            _slab,
}
