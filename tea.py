...
_HERBAL_NOTES = {
    ...
    "fennel":         ["sweet anise", "licorice herbal"],
    "lemon_balm":     ["bright lemon", "citrus herbal"],
    "bergamot":       ["bergamot citrus", "floral citrus"],
    "lemon_verbena":  ["lemon zest", "citrus verbena"],
    "hyssop":         ["herbal hyssop", "minty floral"],
