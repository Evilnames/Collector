...
OUTPOST_TYPES = {
    ...
    "horde_ordu": {
        ...
        "sells": [("mongol_composite_bow", 180), ("turkish_recurve", 165),
                  ...
                  ("feast_aaruul_curd", 7), ("drink_kumis", 6), ("kumis_flask", 12),
    ...
    "mint_ruin": {
        "display_name":    "Ruined Mint",
        "eligible_biomes": ["wasteland", "canyon", "desert", "arid_steppe",
                            "rocky_mountain", "steep_hills"],
        "sells": [("planchet_copper", 14), ("planchet_silver", 38),
                  ("planchet_gold", 95),
                  ("die_fragment_obverse", 55), ("die_fragment_reverse", 55),
                  ("coin_cleaning_kit", 28), ("uncleaned_coin_lot", 22),
                  ("magnifying_loupe", 40)],
        "buys":  [("gold_nugget", 18, 12),
                  ("iron_chunk", 5, 25), ("coal", 6, 20),
                  ("uncleaned_coin_lot", 18, 6)],
        "needs": [("lumber", 14), ("coal", 8)],
        "base_stock": 4, "clothing_key": "alchemist",
        "building_style": "smithy", "half_w": 13, "layout": "default",
        "spawn_chance_mult": 0.6,
    },

    "coin_hoard_dig": {
        "display_name":    "Coin Hoard Dig",
        "eligible_biomes": ["rolling_hills", "temperate", "river_delta",
                            "mediterranean", "rocky_mountain", "steep_hills",
                            "rolling_hills", "wasteland"],
        "sells": [("dig_permit", 32), ("hoard_map", 90),
                  ("stone_pickaxe", 22), ("iron_pickaxe", 80),
                  ("torch", 3), ("uncleaned_coin_lot", 26),
                  ("coin_cleaning_kit", 30)],
        "buys":  [("uncleaned_coin_lot", 14, 12), ("hoard_map", 55, 3),
                  ("gold_nugget", 16, 10),
                  ("iron_chunk", 4, 25)],
        "needs": [("lumber", 10), ("flax_fiber", 6)],
        "base_stock": 4, "clothing_key": "trapper",
        "building_style": "house", "half_w": 12, "layout": "default",
        "spawn_chance_mult": 0.7,
    },

    "counting_house": {
        "display_name":    "Counting House",
        "eligible_biomes": ["temperate", "mediterranean", "rolling_hills",
                            "river_delta", "east_asian"],
        "sells": [("wax_seal_lockbox", 65), ("merchants_ledger", 30),
                  ("weight_scale_brass", 55), ("coin_pouch", 20),
                  ("magnifying_loupe", 38),
                  ("ink_black", 14), ("parchment", 5)],
        "buys":  [("gold_nugget", 22, 14),
                  ("uncleaned_coin_lot", 20, 8),
                  ("ink_black", 12, 8), ("parchment", 3, 30)],
        "needs": [("lumber", 16), ("parchment", 10)],
        "base_stock": 5, "clothing_key": "monk",
        "building_style": "house", "half_w": 14, "layout": "estate",
        "spawn_chance_mult": 0.7,
    },
    ...
    "brickworks": {
        ...
        "eligible_biomes": ["rolling_hills", "temperate", "mediterranean",
                            "river_delta"],
        "sells": [("brick_nogging", 8), ("brick_edging", 6),
                  ("terracotta", 7), ("terracotta_floor_tile", 9),
                  ("terracotta_block", 8)],
        "buys":  [("clay", 3, 40), ("raw_ochre", 10, 12),
                  ("raw_umber", 10, 12), ("raw_sienna", 10, 12)],
        "needs": [("lumber", 18), ("coal", 10)],
        "base_stock": 7, "clothing_key": "blacksmith",
        "building_style": "smithy", "half_w": 14, "layout": "default",
    },

    "stonemason_yard": {
        "display_name":    "Stonemason Yard",
        "eligible_biomes": ["mediterranean", "rocky_mountain", "rolling_hills",
                            "steep_hills", "canyon", "east_asian"],
        "sells": [("limestone_block", 7), ("granite_slab", 9),
                  ("sandstone_ashlar", 11), ("sandstone_column", 14),
                  ("rough_stone_wall", 6), ("chisel", 32)],
        "buys":  [("marble_chunk", 11, 12), ("slate_chunk", 7, 14),
                  ("limestone_chip", 4, 30), ("sandstone", 6, 20),
                  ("cobblestone", 3, 30)],
        "needs": [("lumber", 20), ("iron_chunk", 5), ("coal", 6)],
        "base_stock": 6, "clothing_key": "blacksmith",
        "building_style": "shrine", "half_w": 16, "layout": "default",
    },
    ...
    "mason_hall": {
        ...
        "eligible_biomes": ["temperate", "mediterranean", "rolling_hills",
                            "east_asian"],
        "sells": [("chisel", 30), ("sandstone_column", 13),
                  ("marble_chunk", 14), ("mortar_item", 65),
                  ("hammered_glass", 22), ("sandstone_ashlar", 10)],
        "buys":  [("limestone_block", 5, 20), ("granite_slab", 6, 18),
                  ("marble_chunk", 9, 14), ("sandstone", 5, 22),
                  ("sandstone_ashlar", 7, 12)],
        "needs": [("lumber", 22), ("coal", 8), ("iron_chunk", 6)],
        "base_stock": 5, "clothing_key": "artisan",
        "building_style": "shrine", "half_w": 17, "layout": "estate",
        "spawn_chance_mult": 0.6,
    },

    "sawmill": {
        "display_name":    "Sawmill",
        "eligible_biomes": ["temperate", "redwood", "birch_forest", "boreal",
                            "rolling_hills", "jungle"],
        "sells": [("lumber", 4), ("driftwood_plank", 7),
                  ("wattle_daub", 6), ("wood_door", 22)],
        "buys":  [("lumber", 3, 50), ("sapling", 3, 30)],
        "needs": [("iron_chunk", 6), ("coal", 4)],
        "base_stock": 8, "clothing_key": "lumberjack",
        "building_style": "smithy", "half_w": 15, "layout": "default",
    },

    "joinery_workshop": {
        "display_name":    "Joinery Workshop",
        "eligible_biomes": ["temperate", "mediterranean", "east_asian",
                            "rolling_hills", "birch_forest"],
        "sells": [("wood_door", 24), ("iron_door", 55),
                  ("reed_screen_panel", 18), ("driftwood_plank", 8),
                  ("wattle_daub", 7)],
        "buys":  [("lumber", 5, 25), ("iron_chunk", 7, 12),
                  ("reed_bundle", 5, 14)],
        "needs": [("lumber", 16), ("iron_chunk", 5)],
        "base_stock": 6, "clothing_key": "artisan",
        "building_style": "house", "half_w": 14, "layout": "default",
    },

    "carpenter_lodge": {
        "display_name":    "Carpenter Lodge",
        "eligible_biomes": ["temperate", "redwood", "boreal", "rolling_hills",
                            "birch_forest"],
        "sells": [("wood_door", 22), ("wattle_daub", 6),
                  ("brick_nogging", 8), ("lumber", 5),
                  ("driftwood_plank", 7)],
        "buys":  [("lumber", 4, 35), ("sapling", 3, 20),
                  ("iron_chunk", 6, 10)],
        "needs": [("lumber", 18), ("iron_chunk", 5)],
        "base_stock": 6, "clothing_key": "lumberjack",
        "building_style": "smithy", "half_w": 15, "layout": "estate",
        "spawn_chance_mult": 0.7,
    },

    "tile_kiln": {
        "display_name":    "Tile Kiln",
        "eligible_biomes": ["mediterranean", "rolling_hills", "east_asian",
                            "temperate", "river_delta"],
        "sells": [("terracotta_roof_tile", 9), ("terracotta_shingle", 8),
                  ("terracotta_floor_tile", 9), ("terracotta_path", 7),
                  ("terracotta", 7)],
        "buys":  [("clay", 3, 45), ("raw_ochre", 10, 12),
                  ("raw_sienna", 10, 12)],
        "needs": [("lumber", 16), ("coal", 12)],
        "base_stock": 7, "clothing_key": "blacksmith",
        "building_style": "smithy", "half_w": 14, "layout": "default",
    },

    "thatcher_camp": {
        "display_name":    "Thatcher Camp",
        "eligible_biomes": ["wetland", "swamp", "rolling_hills", "tropical",
                            "savanna", "temperate"],
        "sells": [("thatch_roof", 6), ("reed_screen_panel", 16),
                  ("wattle_daub", 5)],
        "buys":  [("reed_bundle", 4, 25), ("sapling", 3, 20),
                  ("lumber", 3, 25)],
        "needs": [("lumber", 12)],
        "base_stock": 7, "clothing_key": "trapper",
        "building_style": "house", "half_w": 13, "layout": "default",
    },

    "slate_roofers_lodge": {
        "display_name":    "Slate Roofers' Lodge",
        "eligible_biomes": ["alpine_mountain", "rocky_mountain", "steep_hills",
                            "boreal", "rolling_hills"],
        "sells": [("slate_tile", 7), ("rough_stone_wall", 6),
                  ("cobblestone", 4), ("chisel", 32)],
        "buys":  [("slate_chunk", 6, 22), ("slate_tile", 5, 18),
                  ("limestone_chip", 4, 25)],
        "needs": [("lumber", 16), ("iron_chunk", 5)],
        "base_stock": 6, "clothing_key": "blacksmith",
        "building_style": "house", "half_w": 14, "layout": "default",
    ...
    "numismatic_society_lodge": {
        "display_name":    "Numismatic Society Lodge",
        "eligible_biomes": ["temperate", "alpine_mountain", "rolling_hills",
                            "mediterranean", "birch_forest"],
        "sells": [("numismatic_catalogue", 75),
                  ("society_membership_token", 140),
                  ("magnifying_loupe", 42), ("coin_cleaning_kit", 30),
                  ("merchants_ledger", 32), ("dig_permit", 38),
                  ("parchment_fine", 14), ("ink_indigo", 28)],
        "buys":  [("uncleaned_coin_lot", 25, 8),
                  ("hoard_map", 70, 4),
                  ("planchet_gold", 60, 4),
                  ("die_fragment_obverse", 30, 4),
                  ("die_fragment_reverse", 30, 4)],
        "needs": [("lumber", 18), ("parchment", 12)],
        "base_stock": 5, "clothing_key": "monk",
        "building_style": "shrine", "half_w": 15, "layout": "monastery",
        "spawn_chance_mult": 0.55,
    },

    # -----------------------------------------------------------------------
    # Religious outposts — see religion.py. Each spawns a bishop-affiliated
    # building tied to the surrounding region's primary faith. The temple
    # UI (UI/temple.py) handles donate / pilgrimage / confess flows.
    # -----------------------------------------------------------------------

    "cathedral": {
        "display_name":    "Cathedral",
        "eligible_biomes": ["temperate", "mediterranean", "rolling_hills",
                            "river_delta", "rocky_mountain", "grassland",
                            "alpine_mountain"],
        "sells": [("philosophers_scroll", 32), ("votive_tablet", 26),
                  ("olive_branch", 18), ("manuscript_fine", 95),
                  ("parchment_fine", 16), ("ink_indigo", 30)],
        "buys":  [("manuscript_common", 18, 6), ("ink_black", 22, 8),
                  ("parchment", 7, 18), ("oak_gall", 6, 12)],
        "needs": [("lumber", 22), ("leather", 6)],
        "base_stock": 5, "clothing_key": "monk",
        "building_style": "shrine", "half_w": 18, "layout": "monastery",
    },
    ...
    "monastery_scriptorium": {
        ...
        "eligible_biomes": ["birch_forest", "redwood", "boreal",
                            "alpine_mountain", "highlands",
                            "rocky_mountain"],
        "sells": [("manuscript_common", 50), ("manuscript_fine", 90),
                  ("parchment_fine", 14), ("ink_indigo", 28),
                  ("ink_cobalt", 28), ("votive_tablet", 22)],
        "buys":  [("flax_fiber", 4, 30), ("oak_gall", 6, 20),
                  ("parchment", 8, 24), ("ink_black", 20, 8)],
        "needs": [("lumber", 18), ("leather", 6)],
        "base_stock": 5, "clothing_key": "monk",
        "building_style": "shrine", "half_w": 15, "layout": "monastery",
    },

    "pilgrim_shrine": {
        "display_name":    "Pilgrim Shrine",
        "eligible_biomes": ["desert", "savanna", "wetland", "jungle",
                            "mediterranean", "grassland",
                            "rolling_hills"],
        "sells": [("olive_branch", 12), ("votive_tablet", 20),
                  ("philosophers_scroll", 24)],
        "buys":  [("olive_branch", 8, 10), ("votive_tablet", 12, 6),
                  ("ink_indigo", 18, 4)],
        "needs": [("lumber", 8)],
        "base_stock": 4, "clothing_key": "monk",
        "building_style": "shrine", "half_w": 12, "layout": "monastery",
        "spawn_chance_mult": 0.85,
    },

    "heretic_hideout": {
        "display_name":    "Heretic Hideout",
        "eligible_biomes": ["wasteland", "swamp", "wetland",
                            "boreal", "redwood", "rocky_mountain"],
        # Heretics buy and sell the same goods cathedrals do, but at margins
        # that reflect their precarious position — slightly worse buy prices,
        # slightly better sells. They're a way to offload contraband.
        "sells": [("philosophers_scroll", 22), ("votive_tablet", 18),
                  ("manuscript_common", 38)],
        "buys":  [("manuscript_fine", 60, 4), ("manuscript_rare", 160, 2),
                  ("ink_indigo", 22, 6), ("oak_gall", 8, 10)],
        "needs": [("lumber", 8), ("coal", 4)],
        "base_stock": 3, "clothing_key": "monk",
        "building_style": "house", "half_w": 11, "layout": "default",
        "spawn_chance_mult": 0.45,
    },
}

# Set used by the temple UI + outpost menu to detect religious outposts.
RELIGIOUS_OUTPOST_TYPES = {
    "cathedral",
    "monastery_scriptorium",
    "pilgrim_shrine",
    "heretic_hideout",
...
OUTPOST_FLAG_COLORS = {
    ...
    "mint_ruin":                 (185, 145,  70),
    "coin_hoard_dig":            (170, 130,  60),
    "counting_house":            (200, 175,  90),
    "numismatic_society_lodge":  (220, 195, 110),
    "brickworks":                (175,  85,  55),
    "stonemason_yard":           (160, 150, 135),
    "mason_hall":                (215, 205, 185),
    "sawmill":                   (165, 125,  70),
    "joinery_workshop":          (150, 105,  55),
    "carpenter_lodge":           (135,  95,  50),
    "tile_kiln":                 (190,  95,  55),
    "thatcher_camp":             (180, 155,  85),
    "slate_roofers_lodge":       ( 80,  90, 110),
    "cathedral":                 (220, 200, 235),
    "monastery_scriptorium":     (175, 160, 195),
    "pilgrim_shrine":            (215, 195, 130),
    "heretic_hideout":           ( 85,  60,  90),
}
...
BIOME_OUTPOST_TYPES = {
    "temperate":       ("wine_estate",        "herb_monastery",    "border_garrison",
                        ...
                        "coin_hoard_dig",      "counting_house",
                        "numismatic_society_lodge",
                        "sawmill",             "joinery_workshop",  "carpenter_lodge",
                        "brickworks",          "mason_hall",        "tile_kiln",
                        "thatcher_camp",       "cathedral",         "pilgrim_shrine"),
    "boreal":          ("trapper_post",        "boreal_distillery", "timber_camp",
                        "glacier_camp",        "coal_pit",
                        "smokehouse",          "carders_cottage",
                        "highland_dairy",
                        "sawmill",             "carpenter_lodge",
                        "slate_roofers_lodge",
                        "monastery_scriptorium", "heretic_hideout"),
    ...
    "savanna":         ("nomad_camp",          "spirit_distillery", "desert_legion",
                        ...
                        "carpet_caravan",      "thatcher_camp",
                        "pilgrim_shrine"),
    "wasteland":       ("nomad_camp",          "canyon_forge",      "steppe_warcamp",
                        "deep_mine_camp",      "prospector_post",   "coal_pit",
                        "sulfur_pit",          "horde_ordu",        "mint_ruin",
                        "coin_hoard_dig",      "heretic_hideout"),
    "alpine_mountain": ("alpine_monastery",    "cheese_cave",       "highland_fortress",
                        ...
                        "carders_cottage",     "highland_dairy",    "numismatic_society_lodge",
                        "slate_roofers_lodge",
                        "cathedral",           "monastery_scriptorium"),
    "rocky_mountain":  ("cheese_cave",         "canyon_forge",      "highland_fortress",
                        ...
                        "stonemason_yard",     "slate_roofers_lodge",
                        "monastery_scriptorium", "heretic_hideout"),
    "rolling_hills":   ("hillside_vineyard",   "pottery_workshop",  "border_garrison",
                        ...
                        "charcuterie_house",   "compost_yard",
                        "coin_hoard_dig",      "counting_house",
                        "brickworks",          "stonemason_yard",   "mason_hall",
                        "tile_kiln",           "thatcher_camp",     "slate_roofers_lodge",
                        "sawmill",             "carpenter_lodge",
                        "cathedral",           "pilgrim_shrine"),
    ...
    "mediterranean":   ("olive_press",         "wine_estate",       "coastal_citadel",
                        ...
                        "carpet_caravan",      "counting_house",
                        "brickworks",          "stonemason_yard",   "mason_hall",
                        "tile_kiln",           "joinery_workshop",
                        "cathedral",           "pilgrim_shrine"),
    "east_asian":      ("tea_house",           "pottery_workshop",  "silk_pavilion",
                        ...
                        "stonemason_yard",     "mason_hall",        "tile_kiln",
                        "joinery_workshop"),
...
_TYPE_SUFFIXES = {
    ...
    "carpet_caravan":    ["Carpet Caravan", "Dye-Loom Caravan", "Tapestry Caravan",
                          "Weavers' Caravan"],
    "mint_ruin":         ["Ruined Mint", "Forgotten Mint", "Crumbled Mint",
                          "Old Strike-House"],
    "coin_hoard_dig":    ["Hoard Dig", "Coin Excavation", "Treasury Dig",
                          "Hoarders' Cut"],
    "counting_house":    ["Counting House", "Treasury", "Ledger Hall",
                          "Cashier's Lodge"],
    "numismatic_society_lodge":
                         ["Numismatic Society", "Society Lodge",
                          "Coin Collectors' Lodge", "Antiquarian Lodge"],
    "brickworks":        ["Brickworks", "Brickyard", "Kiln Yard", "Clay Works"],
    "stonemason_yard":   ["Stonemason Yard", "Mason's Yard", "Cutter's Yard",
                          "Ashlar Works"],
    "mason_hall":        ["Mason Hall", "Masons' Guildhall", "Stoneguild Hall",
                          "Builders' Hall"],
    "sawmill":           ["Sawmill", "Plank Mill", "Cutting Yard", "Lumber Mill"],
    "joinery_workshop":  ["Joinery", "Joiner's Workshop", "Doorwright's Shop",
                          "Cabinetry"],
    "carpenter_lodge":   ["Carpenter Lodge", "Carpenters' Guildhall",
                          "Woodwrights' Lodge", "Joiners' Lodge"],
    "tile_kiln":         ["Tile Kiln", "Tilers' Kiln", "Roof-Tile Works",
                          "Shingle Kiln"],
    "thatcher_camp":     ["Thatcher Camp", "Thatchers' Lodge", "Reed Roof Camp",
                          "Strawbinder's Camp"],
    "slate_roofers_lodge": ["Slate Roofers' Lodge", "Slaters' Lodge",
                            "Slate Cutters' Lodge", "Roofguild Lodge"],
}
