...
ROCK_TYPES = {
    ...
    "limonite": {
        "min_depth": 5,
        "rarity_pool": ["common", "common", "common", "uncommon"],
        "color_pool": [((175, 140, 60), (205, 168, 88)), ((162, 128, 50), (192, 155, 75))],
        "patterns": ["spotted", "banded", "spotted"],
    },
    "magnetite": {
        "min_depth": 15,
        "rarity_pool": ["common", "common", "uncommon", "uncommon"],
        "color_pool": [((25, 22, 25), (48, 42, 52)), ((18, 16, 20), (40, 36, 45))],
        "patterns": ["solid", "speckled", "solid"],
    },
    "pyrolusite": {
        "min_depth": 20,
        "rarity_pool": ["common", "common", "uncommon", "uncommon"],
        "color_pool": [((52, 50, 55), (78, 75, 82)), ((42, 40, 45), (68, 65, 72))],
        "patterns": ["banded", "solid", "banded"],
    },
    "marcasite": {
        "min_depth": 20,
        "rarity_pool": ["uncommon", "uncommon", "common", "rare"],
        "color_pool": [((195, 185, 110), (218, 208, 138)), ((182, 172, 98), (205, 195, 122))],
        "patterns": ["spotted", "solid", "spotted"],
    },
    "siderite": {
        "min_depth": 25,
        "rarity_pool": ["common", "common", "uncommon", "common"],
        "color_pool": [((175, 148, 95), (200, 175, 120)), ((162, 135, 82), (188, 162, 108))],
        "patterns": ["banded", "banded", "solid"],
    },
    "cinnabar": {
        "min_depth": 35,
        "rarity_pool": ["uncommon", "uncommon", "rare", "rare"],
        "color_pool": [((210, 35, 25), (240, 65, 45)), ((195, 28, 18), (225, 55, 38))],
        "patterns": ["solid", "spotted", "solid"],
        "pigment_drop": "raw_cinnabar",
    },
    "chalcopyrite": {
        "min_depth": 40,
        "rarity_pool": ["uncommon", "uncommon", "common", "rare"],
        "color_pool": [((185, 160, 40), (218, 195, 62)), ((172, 148, 30), (205, 182, 52))],
        "patterns": ["veined", "spotted", "veined"],
    },
    "kernite": {
        "min_depth": 40,
        "rarity_pool": ["uncommon", "uncommon", "common", "rare"],
        "color_pool": [((225, 220, 215), (240, 235, 230)), ((212, 208, 202), (228, 224, 218))],
        "patterns": ["solid", "solid", "speckled"],
    },
    "chalcocite": {
        "min_depth": 45,
        "rarity_pool": ["uncommon", "uncommon", "uncommon", "rare"],
        "color_pool": [((50, 50, 58), (82, 80, 92)), ((40, 40, 48), (72, 70, 80))],
        "patterns": ["solid", "speckled", "solid"],
    },
    "bornite": {
        "min_depth": 50,
        "rarity_pool": ["uncommon", "rare", "uncommon", "rare"],
        "color_pool": [((130, 80, 160), (180, 122, 210)), ((115, 68, 145), (165, 108, 195))],
        "patterns": ["solid", "speckled", "solid"],
    },
    "rutile": {
        "min_depth": 55,
        "rarity_pool": ["uncommon", "uncommon", "common", "rare"],
        "color_pool": [((148, 75, 35), (178, 100, 55)), ((135, 62, 28), (165, 88, 45))],
        "patterns": ["solid", "speckled", "veined"],
    },
    "covellite": {
        "min_depth": 55,
        "rarity_pool": ["rare", "rare", "uncommon", "epic"],
        "color_pool": [((45, 40, 120), (75, 65, 170)), ((35, 30, 105), (62, 55, 155))],
        "patterns": ["solid", "speckled", "solid"],
    },
    "galena": {
        "min_depth": 60,
        "rarity_pool": ["uncommon", "uncommon", "common", "rare"],
        "color_pool": [((160, 160, 170), (130, 130, 142)), ((148, 148, 158), (118, 118, 130))],
        "patterns": ["solid", "speckled", "solid"],
    },
    "tetrahedrite": {
        "min_depth": 60,
        "rarity_pool": ["uncommon", "rare", "uncommon", "rare"],
        "color_pool": [((70, 68, 72), (95, 92, 100)), ((58, 56, 62), (82, 80, 88))],
        "patterns": ["solid", "solid", "speckled"],
    },
    "ilmenite": {
        "min_depth": 65,
        "rarity_pool": ["uncommon", "uncommon", "common", "rare"],
        "color_pool": [((35, 30, 35), (58, 52, 60)), ((28, 24, 28), (48, 44, 50))],
        "patterns": ["solid", "solid", "speckled"],
    },
    "arsenopyrite": {
        "min_depth": 70,
        "rarity_pool": ["uncommon", "rare", "uncommon", "rare"],
        "color_pool": [((190, 192, 188), (165, 168, 162)), ((178, 180, 175), (152, 155, 150))],
        "patterns": ["solid", "speckled", "spotted"],
    },
    "greenockite": {
        "min_depth": 70,
        "rarity_pool": ["rare", "rare", "uncommon", "epic"],
        "color_pool": [((220, 165, 28), (245, 195, 55)), ((205, 152, 18), (230, 182, 42))],
        "patterns": ["solid", "spotted", "solid"],
    },
    "enargite": {
        "min_depth": 75,
        "rarity_pool": ["rare", "rare", "uncommon", "epic"],
        "color_pool": [((48, 45, 52), (72, 68, 78)), ((38, 35, 42), (62, 58, 68))],
        "patterns": ["solid", "solid", "speckled"],
    },
    "nickeline": {
        "min_depth": 80,
        "rarity_pool": ["rare", "rare", "uncommon", "epic"],
        "color_pool": [((188, 115, 80), (215, 142, 102)), ((175, 102, 68), (202, 128, 88))],
        "patterns": ["solid", "speckled", "solid"],
    },
    "bournonite": {
        "min_depth": 80,
        "rarity_pool": ["rare", "rare", "uncommon", "epic"],
        "color_pool": [((55, 50, 58), (82, 78, 88)), ((45, 42, 48), (72, 68, 78))],
        "patterns": ["solid", "spotted", "solid"],
    },
    "chromite": {
        "min_depth": 85,
        "rarity_pool": ["rare", "rare", "uncommon", "epic"],
        "color_pool": [((32, 28, 30), (55, 48, 52)), ((22, 20, 22), (45, 40, 44))],
        "patterns": ["solid", "solid", "speckled"],
        "pigment_drop": "raw_chromium",
    },
    "pentlandite": {
        "min_depth": 90,
        "rarity_pool": ["rare", "rare", "uncommon", "epic"],
        "color_pool": [((175, 148, 60), (200, 175, 82)), ((162, 135, 50), (188, 162, 70))],
        "patterns": ["solid", "spotted", "solid"],
    },
    "molybdenite": {
        "min_depth": 100,
        "rarity_pool": ["rare", "rare", "rare", "epic"],
        "color_pool": [((80, 82, 85), (110, 112, 118)), ((68, 70, 75), (98, 100, 105))],
        "patterns": ["solid", "speckled", "banded"],
    },
    "wolframite": {
        "min_depth": 120,
        "rarity_pool": ["rare", "epic", "rare", "epic"],
        "color_pool": [((45, 35, 30), (72, 58, 48)), ((35, 28, 24), (60, 48, 38))],
        "patterns": ["solid", "banded", "solid"],
    },
    "uraninite": {
        "min_depth": 150,
        "rarity_pool": ["epic", "legendary", "epic", "legendary"],
        "color_pool": [((28, 25, 28), (52, 45, 52)), ((20, 18, 20), (42, 36, 42))],
        "patterns": ["solid", "speckled", "solid"],
    },
...
ROCK_BIOME_AFFINITY = {
    ...
    "ferrous":     {"pyrite", "hematite", "jasper", "onyx", "garnet", "malachite", "serpentine",
                    ...
                    "magnetite", "siderite", "marcasite", "limonite", "ilmenite", "pyrolusite"},
    "sulfide_ore": {"chalcopyrite", "chalcocite", "bornite", "galena", "tetrahedrite", "arsenopyrite",
                    "enargite", "nickeline", "bournonite", "covellite", "cinnabar", "greenockite",
                    "molybdenite", "wolframite", "pentlandite"},
    "oxide_ore":   {"magnetite", "chromite", "ilmenite", "rutile", "uraninite", "limonite",
                    "pyrolusite", "siderite", "marcasite", "kernite"},
...
ROCK_TYPE_DESCRIPTIONS = {
    ...
    # --- Metallic & Sulfide Ores ---
    "limonite":        "A hydrated iron oxide, ochre-yellow and powdery, painting ancient hillsides in warm gold.",
    "magnetite":       "The most magnetic of all minerals — a jet-black iron oxide that pulls a compass needle from a distance.",
    "pyrolusite":      "The principal ore of manganese, dark grey and sooty, deposited in sedimentary seabeds.",
    "marcasite":       "A pale brass-yellow iron sulfide polymorph of pyrite — brighter than fool's gold, but less stable.",
    "siderite":        "A warm tan iron carbonate found in sedimentary beds, an ancient and reliable iron ore.",
    "cinnabar":        "The blazing red ore of mercury — vivid as fire, toxic as any mineral in the earth.",
    "chalcopyrite":    "The most important copper ore, golden-brassy in fresh form, shifting to iridescent tarnish with age.",
    "kernite":         "A soft white boron mineral from evaporite basins, essential to glass and the ancient world's flux.",
    "chalcocite":      "A dark grey copper sulfide formed at depth by descending copper-rich fluids in ore systems.",
    "bornite":         "Peacock ore — a copper sulfide that tarnishes overnight into iridescent purple and gold.",
    "rutile":          "A reddish-brown titanium oxide, a principal ore of titanium and a source of golden-red pigment.",
    "covellite":       "A deep indigo-blue copper sulfide of brilliant metallic color, as vivid as any mineral in the ground.",
    "galena":          "The primary ore of lead — silver-grey, heavy, and cleaving into perfect cubic blocks.",
    "tetrahedrite":    "A gunmetal copper-antimony sulfide, the most widespread sulfosalt ore in hydrothermal systems.",
    "ilmenite":        "An iron-black titanium-iron oxide, the main source of titanium in the world's crust.",
    "arsenopyrite":    "A silver-white iron arsenic sulfide — the most common arsenic mineral and a notable gold indicator.",
    "greenockite":     "A rare vivid yellow-orange cadmium sulfide, found as surface coatings on sphalerite ores.",
    "enargite":        "A dark grey copper arsenic sulfide, forming striated prisms in volcanic hydrothermal systems.",
    "nickeline":       "A copper-red nickel arsenide, one of the original 'Kupfernickel' ores that once baffled miners.",
    "bournonite":      "A grey lead-copper antimony sulfide, crystallizing in distinctive cogwheel-shaped twins.",
    "chromite":        "The sole ore of chromium — a very dark spinel found in ultrabasic igneous and metamorphic rock.",
    "pentlandite":     "A bronze-yellow nickel-iron sulfide and the primary ore of nickel, found in mafic intrusions.",
    "molybdenite":     "A graphite-grey molybdenum sulfide that cleaves into slippery hexagonal flakes like metallic mica.",
    "wolframite":      "A dark brown-black iron-manganese tungstate and the principal ore of tungsten.",
    "uraninite":       "Pitchblende — a pitch-black uranium oxide radiating heat from its own decay, dense beyond reason.",
}
