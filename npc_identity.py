...
_PERSONAL_TRAITS = [
    ...
    "patient in a way that is sometimes mistaken for slowness, until it is too late to take the mistake back",
    "the sort of person who notices when a chair has been moved and does not always mention it",
    "openly skeptical of new ideas and quietly the first to adopt the good ones",
    "fond of weather of all kinds, including the sort that drives other people indoors",
    "inclined to apologize twice for small things and not at all for the larger ones",
    "more comfortable with silence than most people, and willing to outwait it",
    "respected for a kind of plain honesty that occasionally lands them in trouble they accept gracefully",
    "given to small acts of preparation that look like worry until the moment they prove useful",
    "the sort who remembers names and pretends not to in order to spare the other person embarrassment",
    "known to keep a notebook for reasons they have never explained",
    "uncomfortable with unstructured time and inclined to invent tasks to fill it",
    "fond of a routine breakfast and dismissive of anyone who treats meals as negotiable",
    "prone to overestimating others and adjusting only slowly when proven wrong",
    "given to humming under their breath without realizing it, which others find either soothing or maddening",
    "more sentimental about places than about people, which has occasionally surprised them",
    "inclined to walk the long way home for reasons they cannot quite articulate",
    "the sort of person who finishes other people's sentences only when they are sure they have them right",
    "respected for never raising their voice and feared for it on the rare occasions they do",
    "fond of small mended things and disinclined to throw away what can still be patched",
    "known to take an interest in the well-being of strangers that some find touching and others find intrusive",
    "given to long walks during which they appear to be thinking and may simply be walking",
    "more interested in being right than in being seen to be right, which others find refreshing or aggravating",
    "inclined to forgive readily and remember everything, which is not quite the same thing as not forgiving",
    "the sort of person who carries a spare of whatever has been lost in the last decade",
    "fond of telling the same story until they get it the way they want it",
    "known to lend things freely and to keep careful, unspoken records of who returns them",
    "given to sudden, brief enthusiasms that they pursue intensely and then abandon completely",
    "prone to underdressing for cold weather out of a stubbornness that has become identity",
    "respected for a quiet competence that does not announce itself and rarely needs to",
    "inclined to take the blame for small mistakes that were not theirs in order to move past them faster",
    "the sort of person who notices what has changed in a room before they notice who is in it",
    "fond of a particular tavern they will not name and inclined to defend it against all comers",
    "known to be early everywhere and to deny it when accused",
    "given to choosing their battles so carefully that some people assume they have none",
    "more affected by music than they let on and inclined to walk away when it grows unbearable",
    "the sort of person who counts steps without meaning to and cannot say why",
    "inclined to share food and reluctant to share thoughts, which describes them better than they realize",
    "respected by their neighbours and faintly mysterious to everyone who has not had occasion to know them",
    "fond of long answers to short questions and short answers to long ones, on principle",
    "given to remembering exact words from arguments years old and forgetting what they had for supper yesterday",
    "the sort of person who arrives with their sleeves already rolled up",
    "known to feed strays and to deny doing so when asked",
    "inclined to mistrust easy answers and to be patient with hard ones",
    "fond of carrying a small carved token in their pocket, the meaning of which they do not share",
    "given to staring at the horizon during conversations in a way that others find either thoughtful or rude",
    "respected for an evenness of temper that has been earned rather than inherited",
    "more sentimental about old tools than about old letters, and somewhat embarrassed by it",
    "inclined to give directions that are accurate but include landmarks no longer present",
    "the sort of person who never quite finishes their tea and never quite throws it out either",
    "known for a steady gaze that some find reassuring and others find harder to meet than they expected",
    "inclined to whistle while working, badly, and to take any criticism of it as encouragement",
    "the sort of person who reads the weather better than most almanacs and rarely says so out loud",
    "given to an old habit of nodding to strangers that some find quaint and others find welcoming",
    "respected for being equally pleasant before breakfast and after a long day, which is more than most can manage",
    "known to sharpen the same knife three times in a row when something is bothering them",
    "fond of saying \"we'll see\" in a tone that contains an entire judgment",
    "inclined to take in stray problems the way some people take in stray cats",
    "the sort of person who writes letters they never send and keeps them in a drawer for years",
    "given to picking up other people's habits without noticing, and to dropping them just as silently",
    "respected for a steady hand in a crisis and inclined to fall apart only well after it has passed",
    "fond of fixing things that almost work and uninterested in things that work perfectly",
    "known to remember the rain on a specific Tuesday twelve years ago and not what day of the week it is now",
    "inclined to laugh at their own jokes a beat too early, which others have learned to forgive",
    "the sort of person who carries a small knife for everything and has never used it on anyone",
    "given to making lists they immediately lose and the second one is always better",
    "respected for keeping their counsel until the moment when their opinion settles the question",
    "fond of trees they have known a long time and inclined to visit them on their walks",
    "known to apologize to objects they have knocked over and to mean it",
    "inclined to give the benefit of the doubt once, possibly twice, and never a third time",
    "the sort of person who arrives at every wedding with the correct gift and at every funeral with the correct silence",
    "given to a stubborn cheerfulness that has carried them through more than they will say",
    "respected for being entirely themselves, which is harder than it sounds and rarer than it should be",
    "fond of small puzzles they work at without urgency over several days or weeks",
    "known to say very little to people they are angry with, which everyone agrees is the worst of their punishments",
    "inclined to mistake politeness for friendship and to be embarrassed when corrected",
    "the sort of person who counts the geese passing overhead and feels obscurely cheated when the number is low",
    "given to brushing off compliments with a quick joke, which the more observant recognize as defensive",
    "respected for handling unwelcome news without flinching and reserving the flinching for later, in private",
    "fond of bread eaten the day after it was baked and willing to argue about it",
    "known to fall asleep in chairs and wake up insisting they were thinking",
    "inclined to remember the kindnesses done to them by strangers more clearly than any done by family",
    "the sort of person who arrives early and apologizes for it",
    "given to small superstitions they would never admit to following",
    "respected for the unfussy way they handle other people's grief",
    "fond of old songs they sing badly when they think no one is listening",
    "known to write down dreams when they are particularly vivid and burn the page some days later",
    "inclined to suspect anyone who agrees with them too readily",
    "the sort of person who keeps a single drawer in their house in perfect order and the rest in cheerful chaos",
    "given to seeing the funny side of grim news before everyone else has finished reacting",
    "respected for having opinions about the road and the weather and almost nothing else they will share publicly",
    "fond of standing in doorways during conversations, half-in and half-out, as if reserving the right to leave",
    "known to keep a single coin in their pocket for luck and to pretend not to notice when it slips through a hole",
    "inclined to fall quiet at the mention of certain place names and to change the subject without commentary",
    "the sort of person who finds excuses to walk past the same building every few days for reasons they no longer remember",
    "given to lengthy goodbyes that include three additional things they meant to say",
    "respected for the way they sit with sick neighbours without needing to fill the silence",
    "fond of the first hour after dawn and disinclined to share its existence with anyone who sleeps late",
    "known to misplace tools and find them six months later exactly where they were looking the first time",
    "inclined to take a long view of everything except minor inconveniences",
    "the sort of person who, asked their age, takes a moment to count and is briefly surprised by the answer",
    "given to keeping the windows open in all but the harshest weather and unembarrassed about it",
    "inclined to bring small gifts when visiting and to apologize for their inadequacy",
    "respected for an ability to stand still and listen that has gone out of fashion elsewhere",
    "fond of repairing things in ways that improve on their original construction by accident",
    "known to wake at the same hour each morning regardless of when they retired",
    "the sort of person who keeps a single chair facing the door without admitting why",
    "given to the patient cultivation of grievances that they never actually act upon",
    "inclined to treat small inconveniences with elaborate equanimity and minor pleasures with disproportionate joy",
    "respected for never gossiping and quietly informed about more than most gossips",
    "fond of starting projects in the spring and finishing them in winters years later",
    "known to refuse help twice and accept it on the third offer without comment",
    "the sort of person who walks into rooms and rearranges the furniture in their mind",
    "given to the careful pruning of plants and the careless trimming of opinions",
    "inclined to remember exact prices of small purchases from decades past",
    "respected for a willingness to change their mind when shown they were wrong, which they admit dryly",
    "fond of stews that have simmered too long and skeptical of anything served quickly",
    "known to leave coins on graves of people they did not know",
    "the sort of person who keeps a window flower box going through every kind of weather",
    "given to refusing pity even when it would be useful, on principle",
    "inclined to be generous with their time and stingy with their attention, which is not the same thing",
    "respected for an unfussy practicality that has rescued more situations than is widely known",
    "fond of well-made objects and indifferent to whether anyone else notices them",
    "known to take the long way around to avoid a particular intersection without ever saying why",
    "the sort of person who would rather walk than ride and rather ride than be carried",
    "given to small rebellions against minor authorities and a quiet respect for major ones",
    "inclined to make tea for visitors before they ask, and to be slightly hurt when they decline",
    "respected for handling festival days with the same equanimity as ordinary ones",
    "fond of going to bed early and getting up earlier, and inclined to advertise both habits",
    "known to test bridges with a foot before crossing them, which others find quaint",
    "the sort of person who keeps a precisely measured cup of salt in the larder and refills it weekly",
    "given to forgiving slights that other people have already forgotten",
    "inclined to overpay shopkeepers they like and to round prices down for shopkeepers they trust",
    "respected for the way they sit through difficult news without needing to respond immediately",
    "fond of writing letters in pencil and revising them in ink",
    "known to keep a small lamp burning during certain weeks of the year for reasons of their own",
    "the sort of person who arrives with a basket of something seasonal and leaves before being thanked",
    "given to standing outdoors during summer storms with no particular agenda",
    "inclined to leave gates the way they found them and to mention it when others do not",
    "respected for not making a fuss when fuss would be the obvious response",
    "fond of certain crooked trees they pass on regular walks and inclined to greet them",
    "known to be slow to take offense and incapable of being talked out of it once taken",
    "the sort of person who hums different songs depending on the season without realizing the pattern",
    "given to inviting strangers to sit on their porch and never asking their business",
    "inclined to mistrust shortcuts in cooking and in life, with predictable consequences for both",
    "respected for being early to bed and forgiving of those who are not",
    "fond of keeping every letter ever received in a single trunk that is filling up",
    "known to be the calmest person in any room until they decide otherwise",
    "the sort of person who notices when a coin has been replaced and never mentions it",
    "given to feeding the cat first and themselves second and pretending this was not deliberate",
    "inclined to pace when thinking and to apologize if anyone is trying to read",
    "respected for telling the truth without elaborate framing, which some find blunt and others find restful",
    "fond of long sentences in conversation and short ones in writing",
    "known to remember which trees fruit best in which year, which most have forgotten how to track",
    "the sort of person who takes a final look at their work each evening and adjusts one thing",
    "given to walking in the rain on purpose, then complaining about it as though surprised",
    "inclined to make a habit of small acts of trust that have mostly been repaid",
    "respected for not arguing once a thing is decided, even when their position lost",
    "fond of bread baked dark and tea brewed strong",
    "known to leave a coin in the bottom of their cup for the next person",
    "the sort of person who reads slowly and reread passages two or three times in private",
]
